...
app.controller('visaCounsellorController', ['$scope', '$location', '$http', '$timeout', function($scope, $location, $http, $timeout) {
    ...
    $scope.imageSave = function(resultImage) {
        ...
        var request = {
            method: 'POST',
            url: BASE_URL + '/api/visacounsellor/updateProfileImage',
            data: formData,
            headers: {
    ...
    $scope.goTrainingTab = function(experienceLevel) {
        ...
        console.log(data);
        $http.post(BASE_URL + "/api/visacounsellor/updateExpertise", data, { headers: { 'Authorization': `Bearer ${token}` } }).then(function(response) {
    ...
    $scope.goLanguagesTab = function(trainingFrom, trainingTo, trainingDescription) {
        ...
        console.log(data);
        $http.post(BASE_URL + "/api/visacounsellor/updateTraining", data, { headers: { 'Authorization': `Bearer ${token}` } }).then(function(response) {
            if (response.status === 200) {
    ...
    $scope.goFeesTab = function() {
        ...
        console.log(data);
        $http.post(BASE_URL + "/api/visacounsellor/updateLanguages", data, { headers: { 'Authorization': `Bearer ${token}` } }).then(function(response) {
            if (response.status === 200) {
    ...
    $scope.goOverviewTab = function(totalFee) {
        ...
        console.log(data);
        $http.post(BASE_URL + "/api/visacounsellor/updateFees", data, { headers: { 'Authorization': `Bearer ${token}` } }).then(function(response) {
            if (response.status === 200) {
    ...
    $scope.goProfilePhotoTab = function(profileTitle, profileOverview) {
        ...
        console.log(data);
        $http.post(BASE_URL + "/api/visacounsellor/updateProfile", data, { headers: { 'Authorization': `Bearer ${token}` } }).then(function(response) {
            if (response.status === 200) {
    ...
    $scope.sendVerificationCode = function(dialingCode, phoneNumber) {
        ...
        console.log(data);
        $http.post(BASE_URL + "/api/visacounsellor/sendVerificationCode", data, { headers: { 'Authorization': `Bearer ${token}` } }).then(function(response) {
            if (response.status === 200) {
    ...
    $scope.checkVerification = function(digitalCode) {
        ...
        console.log(data);
        $http.post(BASE_URL + "/api/visacounsellor/checkVerificationCode", data, { headers: { 'Authorization': `Bearer ${token}` } }).then(function(response) {
            if (response.status === 200) {
                console.log(response);
